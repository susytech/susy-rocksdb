...
struct rocksdb_compactionfiltsrcontext_t {
...
struct rocksdb_compactionfilterfactory_t : public CompactionFilterFactory {
  ...
  rocksdb_compactionfilter_t* (*create_compaction_filter_)(
      void*, rocksdb_compactionfiltsrcontext_t* context);
  const char* (*name_)(void*);
  ...
  virtual std::unique_ptr<CompactionFilter> CreateCompactionFilter(
    ...
    rocksdb_compactionfiltsrcontext_t ccontext;
...
unsigned char rocksdb_compactionfiltsrcontext_is_full_compaction(
    rocksdb_compactionfiltsrcontext_t* context) {
  return context->rep.is_full_compaction;
}

unsigned char rocksdb_compactionfiltsrcontext_is_manual_compaction(
    rocksdb_compactionfiltsrcontext_t* context) {
