...
typedef struct rocksdb_compactionfiltsrcontext_t
    rocksdb_compactionfiltsrcontext_t;
...
rocksdb_compactionfiltsrcontext_is_full_compaction(
    rocksdb_compactionfiltsrcontext_t* context);

extern ROCKSDB_LIBRARY_API unsigned char
rocksdb_compactionfiltsrcontext_is_manual_compaction(
    rocksdb_compactionfiltsrcontext_t* context);
